...
def process_frame(frame, avg, tracker, min_area=5000):
    ...
    return frame, gray, avg, [centroid[0] for centroid in objects.values()]
...
def main():
    ...
    while True:
        ...
        frame, gray, avg, detected_x = process_frame(frame, avg, tracker)
        ...
        cv2.line(frame, (300, 0), (100, 480), (0, 255, 0), 2)
        cv2.line(frame, (480, 0), (250, 480), (0, 255, 0), 2)    
